<#
    ...
    .EXAMPLE
        ...
        .NOTES
        Credit and Kudos goes to Jon Anderson for the groundwork on this amazing project. 
#>
...
param(
    ...
    [System.IO.FileInfo]$LogFile = "$ENV:ProgramData\Dilly\Lenovo\Manage-LenovoBiosSettings.log"
)
